...
grafo_estructura = ug.generar_grafo_no_dirigido(matriz_adyacencia,diccionario_cabeceras_matriz_adyacencia,indice_max_nombres,indice_max_apellidos,"")
for elemento in grafo_estructura[1]:
    linea = ""
    informacion = grafo_estructura[1][elemento].tolist()
    linea = str(elemento) +"\t"+str(grafo_estructura[1][elemento].tolist())
    print linea
